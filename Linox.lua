...
function Linux.Create(config)
    ...
    CancelButton.MouseButton1Click:Connect(function()
        if not cancelButtonClicked then
            ...
            task.wait(0.3)
            TweenService:Create(CancelButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(21, 21, 21)}):Play()
    ...
    ConfirmButton.MouseButton1Click:Connect(function()
        if not confirmButtonClicked then
            ...
            task.wait(0.3)
            TweenService:Create(ConfirmButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(21, 21, 21)}):Play()
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Button(config)
            ...
            Btn.MouseButton1Up:Connect(function()
                if isPressed then
                    isPressed = false
                    TweenService:Create(Btn, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(21, 21, 21)}):Play()
                end
            end)
